...
public class FarkleStateTest extends TestCase {
    ...
    public void testFarkleState() throws Exception {
        ...
        assertEquals(0, farkleState.getP0score());
        assertEquals(0, farkleState.getP1score());
    ...
    public void testFarkleStateCpy() throws Exception {
        ...
        //initial
        assertEquals(farkleState1.getP0score(), farkleState2.getP0score());
        assertEquals(farkleState1.getP1score(), farkleState2.getP1score());
        ...
        //change P0score
        farkleState1.setP0score(500);
        assertEquals(500, farkleState1.getP0score());
        assertEquals(0, farkleState2.getP0score());

        farkleState2 = new FarkleState(farkleState1);
        assertEquals(500, farkleState2.getP0score());

        //change P1score
        farkleState1.setP1score(500);
        assertEquals(500, farkleState1.getP1score());
        assertEquals(0, farkleState2.getP1score());

        farkleState2 = new FarkleState(farkleState1);
        assertEquals(500, farkleState2.getP1score());
